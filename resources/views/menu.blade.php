					...
					<div class="container">
						...
						@foreach ($dishes as $dish)
							<div class="col-md-4 menu-grid1 simpleCart_shelfItem">
								...
								<div class="cur">
									<div class="cur-left">
										<div class="item_add"><span class="item_price"><a href="#"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a></span>
										</div>
									</div>
									<div class="cur-right">
										<div class="item_add"><span class="item_price"><h6><span>only</span>￥{{$dish->price}}</h6></span></div>
									</div>
									<div class="clearfix"> </div>
								</div>
							</div>
